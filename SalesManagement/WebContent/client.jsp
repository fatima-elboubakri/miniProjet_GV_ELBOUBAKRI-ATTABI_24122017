...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
   <p><span><a href="ClientWeb?action=listClient">List clients >></a></span></p>
            <div class="container-fluid">

    <form method="POST" action='ClientWeb' name="frmAddClient">
        User ID : <input class="form-control" type="text" readonly="readonly" name="clientid"
       ...
       Telephone : <input class="form-control"  type="text" name="telephone"
            value="<c:out value="${client.telephone}" />" /> <br /><input
